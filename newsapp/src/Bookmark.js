...
class Bookmark extends Component {
  ...
  rendering() {
    if (this.state.category == "guardian") return this.renderDet("guardian");
    else return this.renderDet1("NYT");
  }
      ...
      if (this.state.isLoading) {
        return (
          <div className="class-loading">
            <BounceLoader
              css="display: block;margin: 0 auto;border-color: red;position:absolute;top:50%;left:50%"
              size={40}
              color="#123ABC"
            />
          </div>
